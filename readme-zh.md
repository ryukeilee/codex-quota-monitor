...
- `立即刷新` 与设置项分离，减少误触
- 刷新进行中时，菜单和窗口按钮都会进入忙碌状态
- 下方设置区可打开 Dashboard 并调整菜单栏偏好

## 主窗口

- 主窗口改成更像钢铁侠仪表盘的 HUD 风格，强调高对比、强层级和单屏可见
- 核心信息优先级依次是：剩余额度、周额度、5 小时窗口、额度消耗速度、恢复时间和开发建议
- 图表和最近记录是辅助信号，保持紧凑，不允许把页面撑成长页
- 视觉可以很炫，但不能牺牲可读性和一屏看完的目标
