...
- 菜单栏标题以纯百分比形式显示当前周额度剩余，更贴近原生 macOS menubar utility 的长期监控心智
- 菜单中使用中文分区标签显示周额度、重置时间、5 小时窗口和最近刷新
- `立即刷新` 被单独隔离，通知和开机自启动被下移到设置区，减少误触
- 下方设置区可打开 Dashboard、切换迷你面板以及调整菜单栏相关偏好
